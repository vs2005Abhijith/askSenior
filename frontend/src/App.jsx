      ...
      <div className="header chat-header">
        <div>
          ...
          <p className="app-disclaimer">
            <strong>Note:</strong> This webapp is not trained on the complete KTU syllabus. It currently covers DBMS (S4, KTU), OS - Disk Scheduling (S4, KTU), and CN ( S5, KTU). The content is based on the corresponding KTU textbooks.
          </p>
        </div>
